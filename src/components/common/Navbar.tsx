...
const Navbar: React.FC<NavbarProps> = ({ toggleSidebar }) => {
  ...
  return (
    <header className="w-full max-w-screen overflow-x-hidden bg-white shadow-sm p-4 sm:p-6 flex items-center justify-between relative">
  {/* Title */}
  ...
  {isMenuOpen && !toggleSidebar && (
    <div className="absolute top-full left-0 right-0 bg-white shadow-md p-4 sm:hidden max-w-screen overflow-x-hidden">
